...
<div class="row g-2">
  <div class="col-lg-6 col-md-12 mb-6 mb-lg-0">
    <img src="/img/fronteras/a-ghost-truck.jpg" class="w-100 shadow-1-strong rounded mb-2" alt="Behind the Scenes">
    <img src="/img/fronteras/by-boat.jpg" class="w-100 shadow-1-strong rounded mb-2" alt="Behind the Scenes">
    <img src="/img/fronteras/tower-of-cower.jpg" class="w-100 shadow-1-strong rounded mb-2" alt="Behind the Scenes">
  </div>
  <div class="col-lg-6 mb-6 mb-lg-0">
    <img src="/img/fronteras/the-space-between-home.jpg" class="w-100 shadow-1-strong rounded mb-2" alt="Behind the Scenes">
    <img src="/img/fronteras/the-hands-that-hold-us.jpg" class="w-100 shadow-1-strong rounded mb-2" alt="Poster">
    <img src="/img/fronteras/untitled-undocumented.jpg" class="w-100 shadow-1-strong rounded mb-2" alt="Poster">
    <img src="/img/fronteras/volumen-de-voz.jpg" class="w-100 shadow-1-strong rounded mb-2" alt="Poster">
  </div>
</div>
<br><br>
