...
| Full Podcast verification | Passing locally and in CI | Podcast `0.2.16`, PRs #76–#81 / merge `41401d4f147d4642a14f9c53ad4bcd326be8d821`, shared Platform `0.11.5` / worker-core `0.3.6`, and green CI run `30742157784` pass the 486-file tracked secret scan, zero-vulnerability audit, generated Cloudflare types, typecheck, 163 test files / 666 tests, workflow contracts, migration replay, and staging/production dry bundles. Staging migrations through `0087` and Worker version `cb290269-b231-43fe-a66b-9d11939a9fe1` are deployed; production remains untouched and migrations `0067`–`0087` remain unapplied there |
