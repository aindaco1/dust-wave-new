...
| Full Podcast verification | Passing locally and in CI | Secret scan, high-severity dependency audit, Cloudflare types, typecheck, 125 test files / 509 tests, workflow lint, and staging/production dry-run bundles pass |
