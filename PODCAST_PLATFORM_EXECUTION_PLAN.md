...
| Full Podcast verification | Passing locally and in CI | Secret scan, high-severity dependency audit, Cloudflare types, typecheck, 121 test files / 491 tests, workflow lint, and staging/production dry-run bundles pass |
