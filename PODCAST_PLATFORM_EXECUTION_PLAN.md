...
| Full Podcast verification | Passing locally and in CI | Secret scan, high-severity dependency audit, Cloudflare types, typecheck, 127 test files / 514 tests, workflow lint, and staging/production dry-run bundles pass |
