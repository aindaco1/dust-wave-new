...
| Full Podcast verification | Passing locally and in CI | Secret scan, high-severity dependency audit, Cloudflare types, typecheck, 128 test files / 520 tests, workflow lint, and staging/production dry-run bundles pass |
