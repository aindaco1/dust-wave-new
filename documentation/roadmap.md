...
|---|---|---|
| Community calendars | Implemented Microcinema calendar, moderated HQ proposals, private PDFs, and automatic two-script Writers Group scheduling with separate Community admin. Deployed September 8, 2026; [launch evidence](qa/2026-09-08-community-launch.md) records the checks and email-delivery boundary. | [Calendar and scheduling plan](plans/community-calendar.md) |
